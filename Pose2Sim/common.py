...
# Qt backend is optional. In Tkinter GUIs, importing Qt (PyQt5 / Qt5Agg) from a worker thread can
# trigger: "WARNING: QApplication was not created in the main() thread." and can also affect DPI scaling.
# Disable Qt by default unless explicitly enabled.
_DISABLE_QT = os.environ.get("POSE2SIM_DISABLE_QT", "1").lower() not in ("0", "false", "no")

if _DISABLE_QT:
    FigureCanvas = None
    NavigationToolbar = None
    QMainWindow = QApplication = QWidget = QTabWidget = QVBoxLayout = None
else:
    try:
...
def _require_c3d():
    if c3d is None:
        raise ImportError("Package 'c3d' is required for C3D export. Install with: pip install c3d")
...
colors = [(255, 0, 0)    , (0, 0, 255)    , (255, 255, 0)  , (255, 0, 255)  , (0, 255, 255), 
          ...
          (125, 125, 0)  , (125, 0, 125)  , (0, 125, 125)  , (255, 125, 125), (125, 255, 125),
          (125, 125, 255), (255, 255, 125), (255, 125, 255), (125, 255, 255), (125, 125, 125),
          (255, 0, 125)  , (255, 125, 0)  , (0, 125, 255)  , (0, 255, 125)  , (125, 0, 255), 
          (125, 255, 0), (0, 255, 0)]
thickness = 2
