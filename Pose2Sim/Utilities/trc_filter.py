...
'''
    ...
    Butterworth filter, low-pass, 4th order, cut off frequency 6 Hz:
        from PoseAnalysis.Utilities import trc_filter; trc_filter.trc_filter_func(input_file = input_trc_file, output_file = output_trc_file, 
...
# Qt tabs are optional and disabled by default to avoid Qt initialization inside Tkinter apps / worker threads.
