...
PoseAnalysis.calibration()
PoseAnalysis.poseEstimation()
PoseAnalysis.synchronization()
PoseAnalysis.personAssociation()
PoseAnalysis.triangulation()
PoseAnalysis.filtering()
PoseAnalysis.markerAugmentation()
PoseAnalysis.kinematics()
...
class Pose2SimPipeline:
    ...
    def calibration(self):
        from PoseAnalysis.calibration import calibrate_cams_all
    ...
    def poseEstimation(self):
        from PoseAnalysis.poseEstimation import estimate_pose_all
    ...
    def synchronization(self):
        from PoseAnalysis.synchronization import synchronize_cams_all
        for config_dict in self.config_dicts:
    ...
    def personAssociation(self):
        from PoseAnalysis.personAssociation import associate_all
        for config_dict in self.config_dicts:
    ...
    def triangulation(self):
        from PoseAnalysis.triangulation import triangulate_all
        for config_dict in self.config_dicts:
    ...
    def filtering(self):
        from PoseAnalysis.filtering import filter_all
        for config_dict in self.config_dicts:
    ...
    def markerAugmentation(self):
        from PoseAnalysis.markerAugmentation import augment_markers_all
        for config_dict in self.config_dicts:
    ...
    def kinematics(self):
        from PoseAnalysis.kinematics import kinematics_all
        for config_dict in self.config_dicts:
